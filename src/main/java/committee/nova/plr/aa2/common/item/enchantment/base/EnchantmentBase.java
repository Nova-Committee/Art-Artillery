...
public class EnchantmentBase extends Enchantment {
    ...
    public boolean canApplyAtEnchantingTable(@Nonnull ItemStack stack) {
        return switch (type) {
            case 0 -> stack.is(ItemInit.PORTABLE_LAUNCHERS) && !stack.is(ItemInit.FLAK_LAUNCHERS);
            case 1 -> stack.is(ItemInit.FLAK_LAUNCHERS);
            default -> stack.is(ItemInit.PORTABLE_LAUNCHERS);
        };
    }
